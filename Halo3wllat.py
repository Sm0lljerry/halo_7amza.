...
def menu():
    ...
    print logo 
    print 42 * '\x1b[1;91m:'
    print '\x1b[1;94m[1]\x1b[1;93m zhmaray iraq    \x1b[1;91m[0]\x1b[1;91m Exit'
    print '\x1b[1;93m[2]\x1b[1;92m zhmaray iran'
    print '\x1b[1;91m[3]\x1b[1;91m zhmaray turkya'
    print 42 * '\x1b[1;91m:'
    action()
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print logo
        print '\x1b[1;91m 750  751 752 770 772 773 774 780 781 782'
        try:
            c = raw_input('\x1b[1;93m codek halbzhera  : ')
            k = '+964'
            idlist = '.txt'
